...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { key: "availability",  label: "Siteplan",         icon: "Grid3X3",         roles: ["manager", "administrator"] },
  { key: "knowledge",     label: "Knowledge Base",   icon: "Book",            roles: ["manager", "administrator"] },
  { key: "followup",      label: "Follow-Up",        icon: "BellRing",        roles: ["manager", "administrator"] },
