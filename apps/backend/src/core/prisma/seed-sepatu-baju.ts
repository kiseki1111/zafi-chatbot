...
async function main() {
    ...
    data: {
      ...
      knowledgeBases: {
        create: [
          {
            content:
              'Bisa tukar size maksimal 1 hari setelah barang sampai asalkan tag tidak dilepas.',
          },
          {
            content:
              'Pengiriman setiap jam 4 sore. Pesanan di atas jam 3 sore dikirim esok hari.',
          },
        ],
      },
    },
    ...
    data: {
        ...
        create: [
          {
            ...
            description: 'Sepatu putih cocok untuk sekolah/kuliah',
            price: 250000,
            stock: 15,
            category: 'Sneakers',
          },
      ...
      knowledgeBases: {
        create: [
          {
            content:
              'Semua sepatu dijamin original 100%. Uang kembali jika terbukti KW.',
          },
          {
            content:
              'Tersedia ukuran 39 sampai 44. Tidak menerima custom size.',
          },
        ],
      },
    },
  ...
  console.log(
    'Added Toko Baju & Toko Sepatu! Login with: owner@tokobaju.com / owner@tokosepatu.com',
  );
}
