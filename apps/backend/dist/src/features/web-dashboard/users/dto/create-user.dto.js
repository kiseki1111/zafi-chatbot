...
__decorate([
    (0, class_validator_1.IsEmail)({}, { message: 'Format email yang dimasukkan tidak valid' }),
...
__decorate([
    ...
    (0, class_validator_1.MinLength)(8, { message: 'Kata sandi minimal harus berisikan 8 karakter' }),
    __metadata("design:type", String)
], CreateUserDto.prototype, "passwordPlain", void 0);
__decorate([
