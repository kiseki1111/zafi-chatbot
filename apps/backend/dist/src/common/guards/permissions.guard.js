...
let PermissionsGuard = class PermissionsGuard {
    ...
    async canActivate(context) {
        ...
        if (!user) {
            throw new common_1.ForbiddenException('Akses ditolak: Identitas pengguna tidak ditemukan.');
        }
        ...
        throw new common_1.ForbiddenException('Anda tidak memiliki hak akses yang cukup untuk mengeksekusi aksi ini.');
    }
};
